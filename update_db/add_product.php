...
$query = "INSERT INTO `product` (`product_id`, `category_id`, `name`, `slug`, `manufacturer`, `article`, `meta_keywords`, `meta_description`, `meta_title`, `available`, `weight`, `price`, `dimension`, `comment`, `material`, `technic`, `description`, `image_path`, `created_at`, `updated_at`) VALUES ";
